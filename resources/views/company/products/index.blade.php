        ...
        <div class="row">
            <div class="col">
                <div class="card shadow">
                    <div class="card-body">
                        <form id="registerProductForm" class="form-inputs" action="{{ route('products.store') }}"
...
@section('optional_scripts')
    ...
    <script src="{{ asset('assets/js/company/product/validatorProduct.js') }}" type="module"></script>
@endsection
