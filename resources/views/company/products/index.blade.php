...
@section('content')
    ...
    <div class="container-fluid mt--7">
        ...
        <div class="row">
            <div class="col">
                <div class="card shadow" id="productData" data-url="{{ route('company.products.get-more-products') }}">
...
@section('optional_scripts')
    ...
    {{--* Necesarios --}}
    <script src="{{ asset('assets/js/company/products/renderProducts.js') }}" type="module"></script>
