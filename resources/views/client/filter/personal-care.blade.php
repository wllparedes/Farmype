...
@section('title', 'Productos - Cuidado Personal')
            ...
            <div class="header-body">
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-6">
                        <h1 class="text-white text-center">Cuidado Personal</h1>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                @foreach ($productPersonalCare as $productPersonal)
                                    <div class="col-sm-6 col-md-6 col-lg-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <h4 class="card-title">{{ $productPersonal->name }}</h4>
