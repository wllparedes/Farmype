...
@section('title', 'Productos - Mamá y bebe')
            ...
            <div class="header-body">
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-6">
                        <h1 class="text-white text-center">Mamá y bebe</h1>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="container-image">
                                                    <img class="card-img-top" src="{{ verifyImage($productMonBaby->file) }}"
                                                        alt="{{ $productMonBaby->name }}">
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <h4 class="card-title">{{ $productMonBaby->name }}</h4>
